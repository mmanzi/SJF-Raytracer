...
public class ObjReader {
	...
	public static void read(String fileName, float scale, 
						ArrayList<float[]> vertices, ArrayList<float[]> texCoords,
						ArrayList<float[]> normals, ArrayList<int[][]> faces) throws IOException
	{
